...
class CarritoModel
{
    ...
    {
        $sql = "SELECT c.*, p.codigo AS producto_codigo, p.nombre AS producto_nombre, p.estado AS producto_estado, p.id_producto AS producto_id, p.talla AS producto_talla
            FROM $this->tabla c
            LEFT JOIN productos p ON c.id_producto = p.id_producto
