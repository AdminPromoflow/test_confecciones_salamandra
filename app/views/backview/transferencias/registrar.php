        ...
        <div class="col-md-7 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form class="settings-form" id="formularioTransferir">
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <select class="form-control select2-simple" id="codigo" name="codigo" disabled >
                          ...
                          <?php foreach ($productos as $producto): ?>
                            <option value="<?php echo $producto->id_producto ?>" data-stock="<?php echo $producto->cantidad_total ?>"><?php echo $producto->codigo . ' - ' . $producto->nombre_producto ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      <div class="col-md-6 mb-3">
