      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label for="tipoVentaSelect" class="form-label">Tipo de transacción:</label>
              <select class="form-control select2-simple" id="tipoVenta" name="tipoVenta">
          ...
          <div class="row">
            ...
            <div class="col-md-2 mb-3">
              ...
              <input type="text" class="form-control text-white text-center font-weight-bold" id="cantidadProducto" data-cantidadNumero="cantidadNumero" readonly>
            </div>
            <div class="col-md-2 mb-3">
            ...
            <div class="col-md-2 mb-3">
              <label class="form-label"> Otras sucursales </label>
              <button type="button" class="btn btn-info btn-block" id="mostrarSucrsales">
        ...
        <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="number" class="form-control text-end" id="descuento" name="descuento" min="0" value="" placeholder="$ 0" autocomplete="off">
            </div>
            <div class="col-md-4 mb-3">
